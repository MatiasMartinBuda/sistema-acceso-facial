...
# --- PARCHE DE RUTAS FORZADO ---
dir_proyecto = os.path.dirname(os.path.abspath(__file__))

# Asegúrate de tener los archivos .xml en la misma carpeta que main.py
...
# Forzar a OpenCV a reescribir sus variables internas de datos globales
